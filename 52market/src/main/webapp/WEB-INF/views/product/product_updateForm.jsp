...
<div class="page-main">
	...
	<div class="content-main">
		...
		<form id="update_form" action="productUpdate.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="product_num" value="${db_product.product_num}">
			<ul>
				<li>
				...
				<li>
					...
					<input type="text" name="product_title" id="product_title" maxlength="50">
				</li>
				<li>
				...
				<li>
					...
					<textarea name="product_content" id="product_content" rows="5" cols="30"></textarea>
				</li>
				<li>
