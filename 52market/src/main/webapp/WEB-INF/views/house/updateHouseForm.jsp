		...
		<form action="updateHouse.do" id="updateHouseForm" method="post" enctype="multipart/form-data">
			...
			<ul>
				...
				<li>
					...
					<input type="text" name="zipcode" id="zipcode" value="${detail.zipcode}" maxlength="5">
				...
				<li>
					...
					<input type="number" name="house_price" id="house_price" min="1" max="999999999999" value="${detail.house_price}">원
				</li>
				<li>
					<h3><label for="house_diposit">보증금</label></h3>
					<input type="number" name="house_diposit" id="house_diposit" min="0" max="999999999999" value="${detail.house_diposit}">원
				</li>
				<li>
					<h3><label for="house_cost">관리비</label></h3>
					<input type="number" name="house_cost" id="house_cost" min="0" max="99999999" value="${detail.house_cost}">원
				</li>
				<li>
