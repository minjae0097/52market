...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/registerForm.js"></script>
</head>
<body>
<div class="page-main">
	...
	<div class="content-main">
		...
		<form id="register_form" action="register.do" method="post">
			<ul>
				<li>
					<label for="mem_auth">회원유형</label>
					<input type="radio" name="mem_auth" id="mem_auth1" value="2">일반
