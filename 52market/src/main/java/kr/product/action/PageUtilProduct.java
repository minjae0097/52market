...
public class PageUtilProduct {
	 ...
	 * */
	public PageUtilProduct(int currentPage,int count, int rowCount,int status) {
		...
		this(null,null,currentPage,count,rowCount,0,null,status);
	}
	
	public PageUtilProduct(String keyfield, String keyword, int currentPage, int count, int rowCount,
