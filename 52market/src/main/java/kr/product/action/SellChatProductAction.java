...
public class SellChatProductAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(user_num == null) {//로그인이 되지 않은 경우
			...
			String message = "구매확정하시겠습니까?<br>*확정되면 취소할 수 없습니다.<br>*거래후에 확정을 눌러주세요<br>"
					+ "<button id='buy' onclick=\"location.href='buyChatProduct.do?chatroom_num="+Integer.parseInt(request.getParameter("chatroom_num"))+"' \">구매확정</button>";
